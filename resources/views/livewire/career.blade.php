...
<div>
    ...
    <div class="max-lg:h-min max-lg:grid max-lg:grid-cols-1 max-lg:gap-12 lg:flex lg:justify-between lg:gap-8 px-4 md:px-12 lg:px-20 xl:px-28 max-sm:pb-12 sm:py-20">
        <div class="lg:w-4/5 h-min grid grid-cols-1 gap-12">
            <div class="transition-colors group duration-500 hover:text-white text-gray-800 uppercase hover:bg-amber-500 py-5 px-4 sm:px-8 shadow-lg flex justify-between items-center">
                <div>Business Development</div>
                <div>
                    <svg class="w-6 h-6 rotate-90 transition-colors duration-500 text-black group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m9 5 7 7-7 7" />
                    </svg>
                </div>
            </div>
            <div class="h-min grid grid-col-start-1 gap-5">
                <div class="h-min grid grid-col-start-1 gap-3">
                    <div><span class="font-semibold">Location:</span> Florida</div>
                    <div><span class="font-semibold">Department:</span> Marketing</div>
                </div>
                <div class="font-semibold text-sm">We are currently seeking a highly motivated and results-driven Business Development Executive to join our dynamic team at Patrisen. As a Business Development Executive, you will play a pivotal role in driving the growth and expansion of our business.</div>
                <div class="h-min grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-2">
                    <div class="h-min grid grid-cols-1 gap-6">
                        <div class="font-semibold text-2xl text-amber-500">Responsibilities</div>
                        <div class="h-min grid grid-cols-1 gap-3 font-medium">
                            <div class="flex justify-between items-center gap-2">
                                <div class="w-min">
                                    <svg class="w-4 h-4 transition-colors duration-500 text-black group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m9 5 7 7-7 7" />
                                    </svg>
                                </div>
                                <div class="w-full">Identify and evaluate new business opportunities</div>
                            </div>
                            <div class="flex justify-between items-center gap-2">
                                <div class="w-min">
                                    <svg class="w-4 h-4 transition-colors duration-500 text-black group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                ...
                                <div class="w-full">Lead generation and prospecting</div>
                            </div>
                            <div class="flex justify-between items-center gap-2">
                                <div class="w-min">
                                    <svg class="w-4 h-4 transition-colors duration-500 text-black group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                ...
                                <div class="w-full">Client relationship management</div>
                            </div>
                            <div class="flex justify-between items-center gap-2">
                                <div class="w-min">
                                    <svg class="w-4 h-4 transition-colors duration-500 text-black group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                ...
                                <div class="w-full">Proposal development and negotiation</div>
                            </div>
                            <div class="flex justify-between items-center gap-2">
                                <div class="w-min">
                                    <svg class="w-4 h-4 transition-colors duration-500 text-black group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                ...
                                <div class="w-full">Market intelligence and industry awareness</div>
                            </div>
                        </div>
                    </div>
                    <div class="h-min grid grid-cols-1 gap-6">
                        <div class="font-semibold text-2xl text-amber-500">Requirements</div>
                        <div class="h-min grid grid-cols-1 gap-3 font-medium">
                            <div class="flex justify-between items-center gap-2">
                                <div class="w-min">
                                    <svg class="w-4 h-4 transition-colors duration-500 text-black group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                ...
                                <div class="w-full">Bachelor's degree in Business Administration, Marketing, or a related field</div>
                            </div>
                            <div class="flex justify-between items-center gap-2">
                                <div class="w-min">
                                    <svg class="w-4 h-4 transition-colors duration-500 text-black group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                ...
                                <div class="w-full">Proven track record in business development, sales, or a related role</div>
                            </div>
                            <div class="flex justify-between items-center gap-2">
                                <div class="w-min">
                                    <svg class="w-4 h-4 transition-colors duration-500 text-black group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                ...
                                <div class="w-full">Strong knowledge and understanding of the intellectual property industry is a plus</div>
                            </div>
                            <div class="flex justify-between items-center gap-2">
                                <div class="w-min">
                                    <svg class="w-4 h-4 transition-colors duration-500 text-black group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                ...
                                <div class="w-full">Ability to work independently and collaboratively in a fast-paced environment</div>
                            </div>
                            <div class="flex justify-between items-center gap-2">
                                <div class="w-min">
                                    <svg class="w-4 h-4 transition-colors duration-500 text-black group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                ...
                                <div class="w-full">Proficient in using CRM software and other relevant sales tools</div>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="text-center my-4 text-white uppercase text-sm rounded-sm bg-amber-500 whitespace-nowrap py-3 px-6 w-min cursor-pointer transition-colors duration-500 border hover:border-amber-500 hover:bg-white hover:text-amber-500">Apply Now</div>
            <div class="font-medium text-sm">Interested and eligible candidates are requested to send their CV together with personal details by e-mail address <span class="text-amber-500">info@patrisen.com</span></div>
        </div>
        <div class="lg:w-1/5 text-black">
            ...
            <div class="grid grid-cols-1 gap-4">
                ...
                <div class="grid grid-cols-1 gap-2">
                    <div>Comment*</div>
                    <div>
                        <textarea wire:model="comment" rows="4" class="block text-black text-sm bg-gray-100 max-sm:text-sm p-4 w-full outline-none transition-colors transition-shadow duration-500 focus:shadow-lg focus:bg-transparent" placeholder="Comment"></textarea>
                ...
                <div x-data="{showLoader:false}" x-on:career-submit-loader.window="showLoader = $event.detail.value;console.log($event.detail.value)">
                    <div :class="showLoader && 'pointer-events-none'" wire:click="$dispatch('upload-file', { file: $refs.file, fileSizeLimit:1, callbackDispatch:'handle-career-file', callbackLoaderDispatch:'career-submit-loader'})" class="text-center my-4 text-white uppercase text-sm rounded-sm bg-amber-500 whitespace-nowrap py-3 px-6 w-min cursor-pointer transition-colors duration-500 border hover:border-amber-500 hover:bg-white hover:text-amber-500">
                        <div x-show="!showLoader">Submit</div>
                        <svg x-show="showLoader" aria-hidden="true" class="w-6 h-6 mx-3 text-amber-500 animate-spin fill-white" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
