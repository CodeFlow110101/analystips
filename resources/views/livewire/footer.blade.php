    ...
    <div class="bg-slate-700 px-4 md:px-12 lg:px-20 xl:px-28 py-12">
        <div class="grid grid-cols-1 xl:grid-cols-4 gap-14">
            <div class="grid grid-cols-1 gap-4 h-min">
                ...
                <div class="text-lg text-gray-400 leading-tight">Patrisen was founded by a team of experienced patent attorneys with a shared vision of providing unparalleled services in patent research and report preparation. Recognizing the need for a specialized platform that delivers high-quality patent search services, Patrisen was established to support Research & Development, Infringement Analysis, and Commercialization efforts for clients across the globe.</div>
            </div>
            <div class="max-xl:hidden grid grid-cols-1 gap-4 h-min">
                ...
                <div class="text-lg font-light text-gray-200 grid grid-cols-1 gap-2">
            ...
            <div class="max-xl:hidden grid grid-cols-1 gap-4 h-min">
                ...
                <div class="text-lg font-light text-gray-200 grid grid-cols-1 gap-2 h-min">
            ...
            <div class=" grid grid-cols-1 gap-4 h-min">
                ...
                <div class="text-lg font-light text-gray-200 grid grid-cols-1 gap-2 h-min">
                    <div class="text-lg leading-tight flex justify-between items-start gap-2 sm:gap-4">
                        <div>
                    ...
                    <div class="text-lg leading-tight flex justify-between items-center gap-4 w-min whitespace-nowrap">
                        <div>
