...
<div>
    <div class="flex items-center w-full p-4 py-8 sm:p-12 lg:py-36" style="background-image: url('{{ asset('images/pexels-julia-m-cameron-4145190.jpg') }}'); background-size: cover; background-position: center; background-repeat: no-repeat;">
        <div class="rounded-3xl lg:rounded-full bg-pink-500/80 lg:aspect-square text-white flex justify-center items-center max-sm:py-10 max-md:py-10 max-lg:py-32 p-4 sm:p-6">
            <div class="grid grid-cols-1 gap-6 sm:gap-10 text-balance w-full lg:max-w-md text-center">
                ...
                <div class="text-xs sm:text-sm">Exhaustive Patent Research Reports Prepared by an Experienced Team of Attorneys Specializing in Mechanical, Life Sciences, and Engineering Domains.</div>
            </div>
        </div>
    </div>

    <div class="bg-gray-100 max-lg:py-12 max-lg:grid max-lg:grid-cols-1 max-lg:gap-16 lg:flex lg:justify-between lg:gap-12 xl:gap-16 items-center px-4 md:px-12 lg:px-20 xl:px-40">
        <div class="lg:w-3/5">
            <div class="grid grid-cols-1 gap-4 lg:-translate-y-20 bg-white p-6 sm:p-12">
                <div class="sm:tracking-widest text-sky-400 sm:text-lg">Patrisen: Your Trusted Partner in Patent Research and Innovation</div>
                <div class="text-lg sm:text-2xl tracking-wider uppercase font-bold">what we offer as reliable company</div>
                <div class="text-xs dm:leading-6">Patrisen was founded by a team of experienced patent attorneys with a shared vision of providing unparalleled services in patent research and report preparation. Recognizing the need for a specialized platform that delivers high-quality patent search services, Patrisen was established to support Research & Development, Infringement Analysis, and Commercialization efforts for clients across the globe.</div>
                <div class="text-xs sm:leading-6">Our attorneys bring decades of expertise across various technical domains, ensuring that each patent search and research report is meticulously crafted to meet the highest standards. Whether it's navigating the complexities of patent landscapes or providing crucial insights for commercialization, Patrisen is committed to empowering innovation through comprehensive and precise intellectual property services.</div>
                <div class="py-4">
                    <a href="/contact-us" wire:navigate class="text-center text-white uppercase text-sm sm:text-base bg-sky-400 whitespace-nowrap py-2 px-8 w-min cursor-pointer transition-colors duration-500 border hover:border-sky-400 hover:bg-white hover:text-sky-400">Contact us</a>
                </div>
            </div>
        </div>
    ...
    <div class="px-4 md:px-12 lg:px-20 xl:px-40 py-20 grid-cols-1 gap-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 mt-8">
            ...
            <div class="grid grid-cols-1 gap-2">
                ...
                <div class="font-semibold text-lg text-sky-400 capitalize"> {{str_replace('-',' ',$key)}}</div>
            ...
            <div class="grid grid-cols-1 gap-8">
                <div x-data="{showDropdown : false}">
                    <div class="flex justify-between items-center gap-4">
                        ...
                        <div class="text-md w-full font-thin text-gray-800 grid grid-cols-1 gap-4">
                            <div class="text-sky-400 font-semibold">Comprehensive Patent Search Services</div>
                ...
                <div x-data="{showDropdown : false}">
                    <div class="flex justify-between items-center gap-4">
                        ...
                        <div class="text-md w-full font-thin text-gray-800 grid grid-cols-1 gap-4">
                            <div class="text-sky-400 font-semibold">Infringement Analysis</div>
                ...
                <div x-data="{showDropdown : false}">
                    <div class="flex justify-between items-center gap-4">
                        ...
                        <div class="text-md w-full font-thin text-gray-800 grid grid-cols-1 gap-4">
                            <div class="text-sky-400 font-semibold">Commercialization Support</div>
